...
function Login() {
    ...
    //     try {
    //         const response = await login(credentials); // Assuming login is an async function from your API service

    //         if (response.status === 200) {
    //             const isAdmin = credentials.email === 'yugasai6300@gmail.com' && credentials.password === 'Yugasai';
                
    //             if (isAdmin) {
    //                 navigate('/adminHome'); // Navigate to adminHome for admin
    //             } else {
    //                 navigate('/userHome'); // Navigate to userHome for regular users
    //             }
    //         } else {
